...
UPDATE `dpu_template` SET  `jar_name` = 'uv-l-filesToLocalFS-1.5.0.jar'  WHERE `jar_name` LIKE 'uv-l-filesToLocalFS-%.jar';
UPDATE `dpu_template` SET  `jar_name` = 'uv-l-filesToScp-1.4.0.jar'  WHERE `jar_name` LIKE 'uv-l-filesToScp-%.jar';
UPDATE `dpu_template` SET  `jar_name` = 'uv-l-filesToVirtuoso-1.5.0.jar'  WHERE `jar_name` LIKE 'uv-l-filesToVirtuoso-%.jar';
...
UPDATE `dpu_template` SET  `jar_name` = 'uv-t-metadata-1.4.1.jar'  WHERE `jar_name` LIKE 'uv-t-metadata-%.jar';
...
UPDATE `dpu_template` SET  `jar_name` = 'uv-t-zipper-1.5.0.jar'  WHERE `jar_name` LIKE 'uv-t-zipper-%.jar';
...
INSERT INTO `properties` SET `key` = 'UV.Plugins.version', `value` = '001.005.000';
