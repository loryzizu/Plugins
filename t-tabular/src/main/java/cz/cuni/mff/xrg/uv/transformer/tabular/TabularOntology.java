...
public class TabularOntology {
    ...
    static {
        ...
        TABLE_CLASS = valueFactory.createURI("http://unifiedviews.eu/ontology/t-tabular/Table");
        ROW_CLASS = valueFactory.createURI("http://unifiedviews.eu/ontology/t-tabular/Row");
    }
