...
import cz.opendata.unifiedviews.dpus.distributionMetadata.DistributionMetadataConfig_V1;
...
@DPU.AsExtractor
public class DistributionMetadata extends AbstractDpu<DistributionMetadataConfig_V2> {
    ...
    public DistributionMetadata() {
        super(DistributionMetadataVaadinDialog.class,
                ConfigHistory.history(DistributionMetadataConfig_V2.class)
                        .alternative(DistributionMetadataConfig_V1.class)
                        .addCurrent(DistributionMetadataConfig_V2.class));
    }
    ...
    private void generateMetadata() throws DPUException {
        ...
        if (config.isUseDatasetURIfromInput()) {
            ...
            datasetURI = config.getDatasetURI();
        ...
        if (config.isGenerateDistroURIFromDataset()) {
            ...
            distributionURI = config.getDistributionURI();
        ...
        if (config.isOriginalLanguageFromDataset()) {
            ...
            originalLanguage = config.getLanguage_orig();
